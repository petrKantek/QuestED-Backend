...
{
    public class UserRolesTests : IClassFixture<InMemoryApplicationFactory<Startup>>
    {
        private readonly InMemoryApplicationFactory<Startup> _factory;

        public UserRolesTests(InMemoryApplicationFactory<Startup> factory)
        { 
            _factory = factory;
        }
        ...
        public async Task post_should_create_a_new_user(string url)
        {
            ...
            var response2 = await client.GetAsync("api/pupils");
